 ...
 */
@Connector(name="google-spreadsheets", schemaVersion="1.0", friendlyName="Google Spreadsheets Connector", minMuleVersion="3.4", configElementName="config-with-oauth")
@OAuth2(
